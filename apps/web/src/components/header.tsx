          ...
          <nav className="w-full flex items-center justify-between h-[70px] px-4 sm:px-6 lg:px-12 xl:px-20">
            ...
            <div className="hidden lg:flex items-center gap-3 flex-shrink-0">
              ...
              <Link href="/consultation" className="inline-block">
                <button
                  className="bg-primary-yellow hover:bg-yellow-hover text-dark-pure font-semibold px-4 py-2 rounded-lg transition-all whitespace-nowrap text-[14px]"
                >
              ...
              <div className="flex items-center gap-1">
                <a
                  ...
                  className="w-6 h-6 rounded-full bg-white flex items-center justify-center hover:bg-primary-yellow transition-colors group"
                  aria-label="Facebook"
                >
                  <Facebook className="w-3 h-3 text-dark-pure" />
                </a>
                <a
                ...
                >
                  <svg className="w-3 h-3 text-dark-pure" viewBox="0 0 24 24" fill="currentColor">
                ...
                >
                  <Instagram className="w-3 h-3 text-dark-pure" />
                </a>
                <a
                  ...
                  aria-label="YouTube"
                >
                  <Youtube className="w-3 h-3 text-dark-pure" />
                </a>
                <a
